...
class Adviser extends Model
{
     ...
     public static function store($request, $item = null, $columns = ['prefix', 'name', 'main_position', 'position', 'company'])
    {
        ...
        {
        	$item->storeImage($request->file('image_path'), 'image_path', 'advisers-images');
        }
	...
	*/
    ...
    {
        return route($prefix . '.advisers.archive', $this->id);
    }
    ...
    {
        return route($prefix . '.advisers.restore', $this->id);
    }
