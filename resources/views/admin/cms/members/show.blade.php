...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.members.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <members-view
                        fetch-url="{{ route('admin.members.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.members.update', $item->id) }}"
                        ></members-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.members', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
