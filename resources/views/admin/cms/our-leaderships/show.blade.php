...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.our-leaderships.index') }}">Our Leaderships</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.our-leaderships.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <our-leaderships-view
                        fetch-url="{{ route('admin.our-leaderships.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.our-leaderships.update', $item->id) }}"
                        ></our-leaderships-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.our-leaderships', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
