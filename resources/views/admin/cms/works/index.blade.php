...
@section('meta:title', 'Areas of Works')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Areas of Works</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Areas of Works</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <works-table
                        fetch-url="{{ route('admin.works.fetch') }}"
                        ></works-table>
                    </div>
                    <div class="tab-pane" id="tab2">
                        <works-table
                        fetch-url="{{ route('admin.works.fetch.archive') }}"                        
                        ></works-table>
                    </div>
                    <div class="tab-pane" id="tab3">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.works') }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
        ...
        <div class="align-r">
            <a href="{{ route('admin.works.create') }}" class="btn frm-btn type-1 px-4">CREATE</a>
        </div>
    </section>
</div>
