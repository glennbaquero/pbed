...
@section('meta:title', 'Growth Sectors of The Projects')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Growth Sectors of The Projects</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Growth Sectors of The Projects</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        ref="table-1"
                        fetch-url="{{ route('admin.project-priority-areas.fetch', ['is_priority_area' => false]) }}"
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-2"
                        disabled
                        fetch-url="{{ route('admin.project-priority-areas.fetch.archive', ['is_priority_area' => false]) }}"
                        :is-growth-sector="true"
                        ></project-priority-areas-table>
                    </div>
        ...
        <div class="align-r">
            <a href="{{ route('admin.growth-sectors.create') }}" class="btn frm-btn type-1 px-4">CREATE</a>
        </div>
    </section>
</div>
