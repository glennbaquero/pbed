...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.studies.index') }}">Studies</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.studies.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <study-view
                        fetch-url="{{ route('admin.studies.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.studies.update', $item->id) }}"
                        ></study-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab4">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.studies', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
