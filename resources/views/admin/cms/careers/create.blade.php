...
@section('meta:title', 'Create career')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Create Career</h4>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <career-view
                        fetch-url="{{ route('admin.careers.fetch-item') }}"
                        submit-url="{{ route('admin.careers.store') }}"
                        ></career-view>
                    </div>
                </div>
            </div>
