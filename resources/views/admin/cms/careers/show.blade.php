...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.careers.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <career-view
                        fetch-url="{{ route('admin.careers.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.careers.update', $item->id) }}"
                        ></career-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.careers', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
