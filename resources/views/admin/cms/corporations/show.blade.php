...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.corporations.index') }}">Corporations</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.corporations.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <corporation-view
                        fetch-url="{{ route('admin.corporations.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.corporations.update', $item->id) }}"
                        ></corporation-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab4">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.corporations', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
