...
@section('meta:title', 'Our Solution')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Our Solution</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Our Solution</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <solutions-table
                        ref="table-1"
                        fetch-url="{{ route('admin.solutions.fetch') }}"
                        ></solutions-table>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-2"
                        disabled
                        fetch-url="{{ route('admin.solutions.fetch.archive') }}"
                        ></solutions-table>
                    </div>
                    <div class="tab-pane" id="tab3">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.solutions') }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
        ...
        <div class="align-r">
            <a href="{{ route('admin.solutions.create') }}" class="btn frm-btn type-1 px-4">CREATE</a>
        </div>
    </section>
</div>
