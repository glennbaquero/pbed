...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.solutions.index') }}">Our Solutions</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.solutions.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <solution-view
                        fetch-url="{{ route('admin.solutions.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.solutions.update', $item->id) }}"
                        ></solution-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.solutions', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
