...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.blogs.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <blog-view
                        fetch-url="{{ route('admin.blogs.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.blogs.update', $item->id) }}"
                        ></blog-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab4">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.blogs', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
