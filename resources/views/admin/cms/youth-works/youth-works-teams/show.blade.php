...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.youth-works-teams.index') }}">YouthWorks: Teams</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.youth-works-teams.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <youth-works-team-view
                        fetch-url="{{ route('admin.youth-works-teams.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.youth-works-teams.update', $item->id) }}"
                        ></youth-works-team-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab4">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.youth-works-teams', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
