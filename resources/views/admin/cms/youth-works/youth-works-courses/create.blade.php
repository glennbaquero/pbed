...
@section('meta:title', 'Create YouthWorks: Course')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Create YouthWorks: Course</h4>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.youth-works-courses.fetch.item') }}"
                        submit-url="{{ route('admin.youth-works-courses.store') }}"
                        ></youth-works-course-view>
                    </div>
                </div>
            </div>
