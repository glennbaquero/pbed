...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.youth-works-videos.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.youth-works-videos.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.youth-works-videos.update', $item->id) }}"
                        ></youth-works-video-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab4">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.youth-works-videos', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
