...
@section('meta:title', str_limit($item->question, 50))
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">{{ str_limit($item->question, 50) }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.faqs.index') }}">FAQs</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ str_limit($item->question, 50) }}</a></li>
                </ol>
            </div>
        </div>
    </section>
