...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        ref="table-1"
                        fetch-url="{{ route('admin.youthwork-first-frame.fetch', ['is_youthwork' => true]) }}"
                        ></home-first-frame-table>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-2"
                        disabled
                        fetch-url="{{ route('admin.youthwork-first-frame.fetch.archive', ['is_youthwork' => true]) }}"
                        ></home-first-frame-table>
                    </div>
        ...
        <div class="align-r">
            <a href="{{ route('admin.youthwork-first-frame.create') }}" class="btn frm-btn type-1 px-4">CREATE</a>
        </div>
    </section>
</div>
