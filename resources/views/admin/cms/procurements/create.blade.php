...
@section('meta:title', 'Create Procurement')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Create Procurement</h4>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <procurement-view
                        fetch-url="{{ route('admin.procurements.fetch-item') }}"
                        submit-url="{{ route('admin.procurements.store') }}"
                        ></procurement-view>
                    </div>
                </div>
            </div>
