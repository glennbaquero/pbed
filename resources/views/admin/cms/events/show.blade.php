...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.events.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <events-view
                        fetch-url="{{ route('admin.events.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.events.update', $item->id) }}"
                        ></events-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.events', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
