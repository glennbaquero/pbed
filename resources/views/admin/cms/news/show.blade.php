...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.news.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <news-view
                        fetch-url="{{ route('admin.news.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.news.update', $item->id) }}"
                        ></news-view>
                    </div>
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.news', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
