...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.home-first-frame.index') }}">First Frame</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.home-first-frame.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.home-first-frame.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.home-first-frame.update', $item->id) }}"
                        ></home-first-frame-view>
                    </div>
