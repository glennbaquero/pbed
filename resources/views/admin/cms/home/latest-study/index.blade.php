...
@section('meta:title', 'Latest Study')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Latest Study</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Latest Study</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <home-latest-study-table
                        ref="table-1"
                        fetch-url="{{ route('admin.home-latest-study.fetch') }}"
                        ></home-latest-study-table>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        ref="table-2"
                        disabled
                        fetch-url="{{ route('admin.home-latest-study.fetch.archive') }}"
                        ></home-latest-study-table>
                    </div>
        ...
        <div class="align-r">
            <a href="{{ route('admin.home-latest-study.create') }}" class="btn frm-btn type-1 px-4">CREATE</a>
        </div>
    </section>
</div>
