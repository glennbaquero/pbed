...
@section('meta:title', 'Create Contact Category')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="fntwght--semibold font-1">Create Contact Category</h4>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.contact-categories.fetch.item') }}"
                        submit-url="{{ route('admin.contact-categories.store') }}"
                        ></contact-category-view>
                    </div>
                </div>
            </div>
