...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.request-information.index') }}">Request Information</a></li>
    ...
    <page-pagination fetch-url="{{ route('admin.request-information.fetch.pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        ...
                        fetch-url="{{ route('admin.request-information.fetch.item', $item->id) }}"
                        submit-url="{{ route('admin.request-information.update', $item->id) }}"
                    ...
                    <div class="tab-pane bg--white" id="tab2">
                        ...
                        disabled
                        show-subject
                        fetch-url="{{ route('admin.activity-logs.fetch.request-information', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
