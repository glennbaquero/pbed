		...
		<card>
			<div class="frm-prfl__row">
                ...
                <template v-for="(field, key) in fieldsToDisplay">
	                ...
	                <div class="frm-prfl__col col-9">	                	
						<input type="text" :name="field.name_field+'Value'" :value="field.value != undefined ? field.value : null" >
	...
	methods: {
		fetchSuccess(data) {
			...
			if(!this.update) {
				...
				this.fieldsToDisplay = _.orderBy(this.fieldsToDisplay, ['is_definite_fields'], ['desc']);
			}
		},
