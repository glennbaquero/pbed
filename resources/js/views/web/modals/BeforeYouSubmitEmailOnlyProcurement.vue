<template>
	<div>
		<div class="modal fade gen__modal" id="hmModal__precurement-procurement" tabindex="-1" role="dialog" aria-labelledby="hmModal__precurement-procurement" aria-hidden="true">
							...
							<div class="inlineBlock-parent">
								<div class="frm--input m-margin-b">
									<label class="frm--label"><span>Email Address</span>
										<input class="frm--text" type="email" placeholder="" required v-model="payloads.email">
									</label>
								</div>
